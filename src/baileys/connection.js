...
const connect = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { state, saveState } = (0, baileys_1.useSingleFileAuthState)('./src/baileys/cache/auth_info_multi.json');
    ...
    socket.ev.on('connection.update', (update) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (update.qr) {
            qrcode_1.default.toFile('./src/QRBaileys.png', update.qr); // generate the file
        }
        if (connection === 'close') {
